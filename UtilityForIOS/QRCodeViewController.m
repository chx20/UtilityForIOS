...
{
    WQPlaySound* scanSound;
    NSString* lastQRString;
}
...
{    
    ...
    if ([metadataObjects count] >0)
    {
        ...
        _lblOutput.text = stringValue;
        
        if(scanSound == nil)
            scanSound = [[WQPlaySound alloc] initForPlayingSoundEffectWith:@"tap.aif"];
        if(![lastQRString isEqualToString:stringValue]) {
            lastQRString = stringValue;
            [scanSound play];
        }
